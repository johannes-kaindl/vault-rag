...
- **Gegroundeter RAG-Chat** — eine Frage ans Vault stellen und eine Antwort bekommen, die in den gefundenen Notizen verankert ist, Token für Token gestreamt vom lokalen LLM. Ein editierbares Kontext-Panel zeigt, welche Notizen die Antwort speisen, mit Quellen-Chips zum Zurückspringen.
...
- Für **Chat**, **Smart Apply** und LLM-gestütztes Umformatieren: ein **OpenAI-kompatibler lokaler LLM-Endpunkt** (z.B. [LM Studio](https://lmstudio.ai)). Neu bei lokalen LLMs? Der **[Setup-Guide](https://uplink.jkaindl.de/llm-setup)** führt dich durch. In den Einstellungen konfigurierbar; nichts verlässt deine Maschine.
...
|---|---|---|
| Embedding-Endpunkt / Modell | Bettet Notizen beim Speichern neu ein | `http://localhost:11434` · `qwen3-embedding:8b` |
| Chat-Endpunkt / Modell | LLM für Chat, Smart Apply und Umformatieren | `http://localhost:1234` · `qwen3` |
