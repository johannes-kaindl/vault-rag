...
// Schreibweisen-tolerant, weil derselbe Gemma je nach Anbieter anders heisst: Ollama `gemma3:4b`,
// LM Studio `google/gemma-3-4b-it`. Die frühere Fassung (`/gemma3/`) kannte nur Ollama und meldete
// LM-Studio-Gemmas sowie die gesamte Gemma-4-Reihe als vision-los, obwohl sie multimodal sind
// (2026-08-07 durch den aktiven Vision-Test in image-to-markdown belegt). Identisch mit der
// Fassung aus obsidian-kit 0.25.1 — diese Datei ist der Fork von vor der Kit-Extraktion; die
// Zeilen anzugleichen verkleinert die Divergenz und macht die geplante Migration einfacher.
const GEMMA_VISION = /gemma[-_]?[34]/;                     // ≥4B; 1b/270m sind text-only
